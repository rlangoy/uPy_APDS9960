...
intersphinx_mapping = {'python': ('https://docs.python.org/3.5', None),'machine': ('https://micropython.readthedocs.io/projects/machine/en/latest/',None)'micropython': ('https://micropython.readthedocs.io/en/latest/',None)}
